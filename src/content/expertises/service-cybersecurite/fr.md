...
permalink: /fr/expertises/service-cybersecurite/
title: "Cybersécurité"
lead: "Audit, conformité et défense : protégez vos systèmes d'information et vos données."
description: "Cybersécurité — expertise Meritis."
parent:
  label: "Expertises"
  url: "/fr/expertises/"
---
...
![Cybersécurité Meritis cyberdéfence](/assets/images/expertises/service-cybersecurite/inline-1.webp)
...
**Quels que soient vos besoins, Meritis vous accompagne** dans chaque étape de votre projet :
...
[_Selon L’ANSSI_](http://www.senat.fr/rap/r20-678/r20-6781.pdf)

## Nos services cybersécurité

La cybersécurité en entreprise ne s’improvise pas ! Notre expérience garantit le succès de vos projets.

## Audit de sécurité &analyse des risques

L’analyse des risques qui pèsent sur une organisation ou un projet permet d’identifier les menaces et de s’en prémunir.
Audit de **norme**, Audit de **code source**
Tests d’intrusion (**Pentest**), Audit de **l’architecture** (cloud, physique), Audit du **réseau de sécurité**.

Plus qu’un simple Audit, nous donnons des **conseils** et sensibilisons aux **bonnes pratiques de la cybersécurité**.

## Mise en conformité &accompagnement à la certification

**Valorisez votre expertise et la santé de votre entreprise grâce aux certifications.** Norme **ISO 27001**, **HDS** ou quel que soit votre projet incluant la **RGPD**; notre équipe expérimentée et pluridisciplinaire vous accompagne dans chaque étape quelque soit votre projet.

## Détection & réaction face aux cyberattaques

Aussi appelé intervention **Forensic**, nous intervenons après une cyberattaque afin de vous permettre de vous préoccuper uniquement de l’essentiel : le lmaintien et Forensic de votre activité !

Collecte des **preuves numériques, sécurisation du périmètre impacté, assistance aux procédures judiciaires…**
Nous vous accompagnons lors de toutes ces étapes.

## Transformation DevSecOps

Profitez des avantages qu’offre la méthode **DevOps** en incorporant une phase de **sécurité** **en plus !**
...
![Livre Blanc Cybersécurité ebook 3d - transparent](/assets/images/expertises/service-cybersecurite/inline-6.webp)

## Découvrez 4 bonnes pratiques pour anticiper et éviter une cyberattaque.

-   **Comment bien se protéger ?**
-   **Avez-vous les bons réflexes ?**

## Notre méthode DevSecOps
...
![Methode DevSecOps ](/assets/images/expertises/service-cybersecurite/inline-7.webp)

* * *

## Meritis, un accompagnement de bout en bout

Nos compétences Techniques et Métier nous permettent de couvrir l’ensemble de votre projet Cybersécurité, du cadrage et de l’analyse, en passant par la mise en place d’une stratégie , jusqu’à l’accompagnement métier.
...
## Meritis est 100% impliqué dans l’application du règlement général sur la protection des données (RGPD).

![Meritis est conforme au RGPD](/assets/images/expertises/service-cybersecurite/inline-8.webp)

La réglementation européenne du 23 mai 2018, qui reprend les obligations  du RGPD (GDPR en anglais) vise à protéger les données personnelles des utilisateurs. Toutes les entreprises Européennes **ont l’obligation légale de se soumettre** à ces mesures de protection du consommateur sous peine de sanctions.
Les autorités de contrôle ont laissé 2 ans aux différents acteurs pour s’y soumettre. Toutefois, certaines entreprises ont du retard. On compte déjà **300 millions d’euros d’amendes en France** en moins de 3 ans.

**Et vous, où en êtes-vous ?  Nous pouvons vous aider !**

> La qualité des consultants Meritis, tant sur le plan technique que humain, associée à leur capacité à faire monter nos équipes en compétences pour répondre au mieux à nos besoins nous satisfait pleinement.
> Meritis montre un fort intérêt pour nos sujets et s’inscrit dans une véritable démarche partenariale.
>
> Responsable SI d’une grande entreprise ferroviaire
