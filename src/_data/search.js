...
export default {
  fr: {
    ...
    popular: ["Data & IA", "Cloud", "DevOps", "Finance", "Cybersécurité", "Agilité", "IA générative"],
    browseHeading: "Parcourir le site",
    browse: [
      { route: "expertises", title: "Nos expertises", desc: "Conseil, ingénierie et delivery sur 9 domaines." },
  ...
  en: {
    ...
    browse: [
      { route: "expertises", title: "Our expertise", desc: "Consulting, engineering and delivery across 9 areas." },
