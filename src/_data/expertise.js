...
export default {
  fr: {
    ...
    domains: [
      {
        img: "/assets/images/expertise/data-ia.webp",
        alt: "Data & IA chez Meritis",
        title: "Data & IA, Digital Engineering",
        desc: "Plateformes data, gouvernance de la donnée, IA générative, modernisation applicative et DevOps. Nous transformons la donnée en valeur, du socle technique jusqu'aux cas d'usage en production.",
      },
      {
        img: "/assets/images/expertise/fiabilite.webp",
        alt: "Fiabilité et performance des services IT",
        title: "Fiabilité & performance des services IT",
        desc: "Cloud, réseaux, cybersécurité, environnement de travail et performance applicative. Nous garantissons des services IT robustes, sécurisés et disponibles, à la hauteur des environnements critiques.",
      },
      {
        img: "/assets/images/expertise/pilotage.webp",
        alt: "Pilotage de la transformation et impact sociétal",
        title: "Pilotage & impact sociétal",
        desc: "Gouvernance de la transformation, organisation IT, numérique responsable et conduite du changement. Nous alignons la stratégie technologique sur vos enjeux métier et sociétaux.",
      },
      {
        img: "/assets/images/expertise/finance.webp",
        alt: "Finance et conformité",
        title: "Finance & conformité",
        desc: "Opérations front, middle et back office, conformité et ESG. Une double expertise IT et métier au service des banques d'investissement, assureurs et asset managers.",
      },
    ],
  ...
  en: {
    ...
    domains: [
      {
        img: "/assets/images/expertise/data-ia.webp",
        alt: "Data & AI at Meritis",
        title: "Data & AI, Digital Engineering",
        desc: "Data platforms, data governance, generative AI, application modernisation and DevOps. We turn data into value, from the technical foundation to use cases in production.",
      },
      {
        img: "/assets/images/expertise/fiabilite.webp",
        alt: "IT service reliability and performance",
        title: "IT service reliability & performance",
        desc: "Cloud, networks, cybersecurity, digital workplace and application performance. We ensure robust, secure and available IT services, fit for critical environments.",
      },
      {
        img: "/assets/images/expertise/pilotage.webp",
        alt: "Transformation steering and societal impact",
        title: "Steering & societal impact",
        desc: "Transformation governance, IT organisation, sustainable digital and change management. We align technology strategy with your business and societal stakes.",
      },
      {
        img: "/assets/images/expertise/finance.webp",
        alt: "Finance and compliance",
        title: "Finance & compliance",
        desc: "Front, middle and back office operations, compliance and ESG. A dual IT and business expertise serving investment banks, insurers and asset managers.",
      },
    ],
